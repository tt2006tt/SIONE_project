#ifndef __ADPS9960__H_
#define __ADPS9960__H_
#include "stm8l15x.h"
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
...
#define APDS9960_I2C_ADDR       0x39 //7位置
#define APDS9960_I2C_RADDR     	0x73//((0x39 << 1)| 0x01)
#define APDS9960_I2C_WADDR      0x72//((0x39 << 1) & 0xFE)
...
#define SCL_L      I2C_PORT->ODR &= (uint8_t)(~I2C_SCL_PIN);
#define SDA_H      I2C_PORT->ODR |= I2C_SDA_PIN 
#define SDA_L      I2C_PORT->ODR &= (uint8_t)(~I2C_SDA_PIN)
#define SDA_READ             ((BitStatus)(I2C_PORT->IDR & I2C_SDA_PIN))
#define SCL_READ             ((BitStatus)(I2C_PORT->IDR & I2C_SCL_PIN))
//SCL可以设为推挽或开漏高阻输出
//SDA输出可以设为推挽或开漏高阻输出，输入时设为开漏输入，SDA必须接上拉电阻
#define Set_I2C_SCL_Out      GPIO_Init(I2C_PORT, I2C_SCL_PIN, GPIO_Mode_Out_OD_HiZ_Fast)
#define Set_I2C_SCL_In       GPIO_Init(I2C_PORT, I2C_SCL_PIN, GPIO_Mode_In_FL_No_IT)
#define Set_I2C_SDA_Out_H      GPIO_Init(I2C_PORT, I2C_SDA_PIN, GPIO_Mode_Out_OD_HiZ_Fast)
#define Set_I2C_SDA_Out_L      GPIO_Init(I2C_PORT, I2C_SDA_PIN, GPIO_Mode_Out_PP_Low_Fast)
#define Set_I2C_SDA_In       GPIO_Init(I2C_PORT, I2C_SDA_PIN, GPIO_Mode_In_PU_No_IT )

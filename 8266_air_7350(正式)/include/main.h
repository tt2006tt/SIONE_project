...
#include "include\SC92F735x_C.h"
#include "include\735X_IO.h"
#include"intrins.h"
...
typedef struct
{
    ...
    unsigned char  Cnt_Warning0;        //计时器，警告状态  
		unsigned char  Cnt_Warning1;        //计时器，警告状态  
		unsigned char  Cnt_Warning2;        //计时器，警告状态  
		unsigned char  Cnt_Warning3;        //计时器，警告状态  
    unsigned long  Cnt_Minite;       //计时器，分钟
    unsigned char   flag_revise;			 //校准标志位  0 位校准   1为校准完成
